...
#define spi_readwrite m_spi.transfer
#define spi_read() spi_readwrite(0x00)

#define SPIFREQUENCY 1000000 // 1Mhz limit
...
{
    m_spi.beginTransaction(SPISettings(SPIFREQUENCY, MSBFIRST, SPI_MODE0));
    MCP2515_SELECT();
...
*********************************************************************************************************/
INT8U MCP_CAN::begin(SPIClass &spi, INT8U idmodeset, INT8U speedset, INT8U clockset)
{
    INT8U res;
